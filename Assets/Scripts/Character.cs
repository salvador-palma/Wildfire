...
public class Character : MonoBehaviour
{
    ...
    [SerializeField] private GameObject LeaderBoardPanelTemplate;
    [SerializeField] private DynamicText LeaderBoardLoadingText;
    [SerializeField] private DynamicText LeaderBoardTitleText;
    ...
    {
        currentDisplayedCharacter = characterDatas.ToList().FindIndex(0, characterDatas.Length - 1, c => c.AbilityName == ability_name);
        UpdateCharacterInfo(characterDatas[currentDisplayedCharacter]);
        int index = 0;
    ...
    {
        foreach (Transform child in LeaderBoardPanelTemplate.transform.Find("Slots"))
        {
            if (child.gameObject.activeSelf)
                Destroy(child.gameObject);
        }
        LeaderBoardPanelTemplate.transform.Find("PersonalSlot").gameObject.SetActive(false);

        CharacterData data = characterDatas[currentDisplayedCharacter];
