...
public class DeckBuilder : MonoBehaviour
{
    ...
    public void DefineAugmentClasses(){
        AllAugments = new List<Augment>
        {
            ...
            new Augment("IcePoolProb","Cold Steps", "Gain +5% probability of spawning a Snow Pool when your shot lands", "IcePoolProb", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0.05f,0))), immoType:IMMOLATE.AIR),
            new Augment("IcePoolProb","Ice Here, Ice There", "Gain +10% probability of spawning a Snow Pool when your shot lands", "IcePoolProb", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0.1f,0))), immoType:IMMOLATE.AIR),
            new Augment("IcePoolProb","The North Pole", "Gain +25% probability of spawning a Snow Pool when your shot lands", "IcePoolProb", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0.25f,0))), immoType:IMMOLATE.AIR),
            ...
            new Augment("ThornsPerc","Innocent Spikes", "Your Thorns effect will reflect +10% of your Armor", "ThornsPerc", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnHittedEffect(new ThornsOnHitted(0, .1f))), immoType:IMMOLATE.EARTH),
            new Augment("ThornsPerc","Spiky Vengeance", "Your Thorns effect will reflect +20% of your Armor", "ThornsPerc", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnHittedEffect(new ThornsOnHitted(0, .2f))), immoType:IMMOLATE.EARTH),
            new Augment("ThornsPerc","Puffer Fish", "Your Thorns effect will reflect +50% of your Armor", "ThornsPerc", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnHittedEffect(new ThornsOnHitted(0, .5f))), immoType:IMMOLATE.EARTH),
            ...
            new Augment("Whirlpool" ,"Whirlpool", "Unlock the ability to create Whirlpools", "WhirlpoolUnlock", Tier.Prismatic, new UnityAction(()=> {
                ...
                Flamey.Instance.addOnLandEffect(new Whirpool(0.10f, 0.05f));
                Deck.Instance.AddAugmentClass(new List<string>{"WhirlpoolProb","WhirlpoolForce"});
            }), baseCard: true, immoType:IMMOLATE.AIR),

            new Augment("WhirlpoolProb","Spiraling Waters", "Gain +3% chance of generating a Whirlpool", "WhirlpoolProb", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new Whirpool(0, 0.03f))), immoType:IMMOLATE.AIR),
            new Augment("WhirlpoolProb","Call of the Nymphs", "Gain +7.5% chance of generating a Whirlpool", "WhirlpoolProb", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new Whirpool(0, 0.075f))), immoType:IMMOLATE.AIR),
            new Augment("WhirlpoolProb","Ariel's Charm", "Gain +15% chance of generating a Whirlpool", "WhirlpoolProb", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new Whirpool(0, 0.15f))), immoType:IMMOLATE.AIR),
            new Augment("WhirlpoolForce","Tidal Waves", "Whilrpools will pull with +5 force", "WhirlpoolPull", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new Whirpool(0.05f, 0))), immoType:IMMOLATE.AIR),
            new Augment("WhirlpoolForce","Heroes of the Sea", "Whilrpools will pull with +10 force", "WhirlpoolPull", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new Whirpool(0.1f, 0))), immoType:IMMOLATE.AIR),
            new Augment("WhirlpoolForce","The Kraken", "Whilrpools will pull with +25 force", "WhirlpoolPull", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new Whirpool(0.25f, 0))), immoType:IMMOLATE.AIR),


            new Augment("Smog" ,"Smog", "Unlock the ability to poison enemies", "PoisonUnlock", Tier.Prismatic, new UnityAction(()=> {
                Deck.Instance.removeClassFromDeck("Smog");
                Flamey.Instance.addOnKillEffect(new Smog(0.10f, 25, 5));
                Deck.Instance.AddAugmentClass(new List<string>{"SmogProb","SmogTicks", "SmogArea"});
            }), baseCard: true, immoType:IMMOLATE.AIR),

            new Augment("SmogProb","Patient Zero", "Gain +5% chance of releasing Smog", "PoisonProb", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Smog(0.05f, 0, 0))), immoType:IMMOLATE.AIR),
            new Augment("SmogProb","Cyanide", "Gain +10% chance of releasing Smog", "PoisonProb", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Smog(0.1f, 0, 0))), immoType:IMMOLATE.AIR),
            new Augment("SmogProb","Viper's Den", "Gain +25% chance of releasing Smog", "PoisonProb", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Smog(0.25f, 0, 0))), immoType:IMMOLATE.AIR),
            new Augment("SmogTicks","Persistent Virus", "Your Smog deals +1 poison tick", "PoisonSpread", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Smog(0, 0, 1))), immoType:IMMOLATE.AIR),
            new Augment("SmogTicks","No Antidote", "Your Smog deals +2 poison ticks", "PoisonSpread", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Smog(0, 0, 2))), immoType:IMMOLATE.AIR),
            new Augment("SmogTicks","Kiss of Death", "Your Smog deals +5 poison tick", "PoisonSpread", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Smog(0, 0, 5))), immoType:IMMOLATE.AIR),
