...
public class DeckBuilder : MonoBehaviour
{
    ...
    public void DefineAugmentClasses(){
        ...
        {
            new Augment("Dmg","Hard Work", "Gain +10 Base Damage", "Dmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addDmg(10)),baseStat: true),
            new Augment("Dmg","Heavy Hitter","Gain +25 Base Damage", "Dmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addDmg(25)), baseStat: true),
            new Augment("Dmg","Hephaestus","Gain +50 Base Damage", "Dmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addDmg(50)), baseStat: true),
            ...
            new Augment("Health","Absolute Unit", "Heal 100% of your Max Health and gain +1000 HP", "Health", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addHealth(1000,1f)),baseStat: true),

            new Augment("Armor","Mesh Armor", "Increase your armor by +10", "Armor", Tier.Silver, new UnityAction(() => Flamey.Instance.addArmor(10)), baseStat: true),
            new Augment("Armor","Long Lasting Fire", "Increase your armor by +25", "Armor", Tier.Gold, new UnityAction(() => Flamey.Instance.addArmor(25)), baseStat: true),
            new Augment("Armor","The Armor of God", "Increase your armor by +50", "Armor", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addArmor(50)), baseStat: true),    
            ...
            new Augment("CritMult","Lucky Shots", "Gain +15% critical strike damage", "CritMult", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnShootEffect(new CritUnlock(0f, 0.15f)))),
            new Augment("CritMult","Critical Thinking", "Gain +30% critical strike damage", "CritMult", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnShootEffect(new CritUnlock(0f, 0.3f)))), 
            
            new Augment("CritChance","Critical Miracle", "Gain +5% critical strike chance", "CritChance", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnShootEffect(new CritUnlock(0.05f, 0f)))),
            new Augment("CritChance","Fate's Favor", "Gain +10% critical strike chance", "CritChance", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnShootEffect(new CritUnlock(0.1f, 0f)))),  
            new Augment("CritChance","Overheat", "Gain +25% critical strike chance and +60% critical strike damage", "CritChance", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnShootEffect(new CritUnlock(0.25f, 0.6f)))),    
            ...
            new Augment("IceProb","IcyHot","Gain +5% chance to proc your Frost Fire effect", "IceProb", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnHitEffect(new IceOnHit(0, 0.05f)))),
            new Augment("IceProb","Glacial Energy","Gain +15% chance to proc your Frost Fire effect", "IceProb", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnHitEffect(new IceOnHit(0, 0.15f)))), 
            new Augment("IceProb","A Dance of Fire and Ice","Gain +35% chance to proc your Frost Fire effect", "IceProb", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnHitEffect(new IceOnHit(0, 0.35f)))),  
            new Augment("IceDuration","Slowly but Surely", "Your Frost Fire effect lasts for 0.5 seconds more", "IceDuration", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnHitEffect(new IceOnHit(500, 0)))),
            new Augment("IceDuration","Frost Bite", "Your Frost Fire effect lasts for 1 seconds more", "IceDuration", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnHitEffect(new IceOnHit(1000, 0)))),
            new Augment("IceDuration","Absolute Zero", "Your Frost Fire effect lasts for 2.5 seconds more", "IceDuration", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnHitEffect(new IceOnHit(2500, 0)))),
            ...
            new Augment("Execute","La Guillotine", "You can execute enemies for +10% of their Max Health", "Execute", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnHitEffect(new ExecuteOnHit(0.1f)))),
            new Augment("ArmorPen","Shell Breaker", "Gain +5% Armor Penetration", "ArmorPen", Tier.Silver, new UnityAction(() => Flamey.Instance.addArmorPen(0.05f))),
            new Augment("ArmorPen","Quantum Piercing", "Gain +10% Armor Penetration", "ArmorPen", Tier.Gold, new UnityAction(() => Flamey.Instance.addArmorPen(0.10f))),
            new Augment("ArmorPen","Lance of Aether", "Gain +25% Armor Penetration", "ArmorPen", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addArmorPen(0.25f))),
            ...
            new Augment("BlueFlameDmg","Propane Leakage", "Your Blue Flame deals +25 extra damage", "BlueFlameDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnShootEffect(new KrakenSlayer(0, 25)))),
            new Augment("BlueFlameDmg","Powerfull Blue", "Your Blue Flame deals +50 extra damage", "BlueFlameDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnShootEffect(new KrakenSlayer(0, 50)))),
            new Augment("BlueFlameDmg","Blue Inferno", "Your Blue Flame deals +100 extra damage", "BlueFlameDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnShootEffect(new KrakenSlayer(0, 100)))),
            ...
            new Augment("OrbitalAmount","Tame the Flames", "Gain +1 Flame in your Orbital Field", "OrbitalAmount", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addNotEspecificEffect(new FlameCircle(1, 0)))),
            new Augment("OrbitalDmg","Tiny Flames Win", "Your Orbital Flames deal +10 damage", "OrbitalDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addNotEspecificEffect(new FlameCircle(0, 20)))),
            new Augment("OrbitalDmg","Reliable Damage", "Your Orbital Flames deal +25 damage", "OrbitalDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addNotEspecificEffect(new FlameCircle(0, 25)))),
            new Augment("OrbitalDmg","Saturn", "Your Orbital Flames deal +50 damage", "OrbitalDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addNotEspecificEffect(new FlameCircle(0, 50)))),
            ...
            new Augment("LavaPoolDmg","Hot Tub", "Your Lava Pool will inflict +10 damage per second", "LavaPoolDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,10,0,0)))),
            new Augment("LavaPoolDmg","Magical Scorch", "Your Lava Pool will inflict +25 damage per second", "LavaPoolDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,25,0,0)))),
            new Augment("LavaPoolDmg","Conflagration", "Your Lava Pool will inflict +50 damage per second", "LavaPoolDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,50,0,0)))),
            new Augment("LavaPoolProb","Hot Steps", "Gain +5% probability of spawning a Lava Pool when your shot lands", "LavaPoolProb", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,0,0.05f,0)))),
            new Augment("LavaPoolProb","Lava here, Lava there", "Gain +10% probability of spawning a Lava Pool when your shot lands", "LavaPoolProb", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,0,0.10f,0)))),
            new Augment("LavaPoolProb","The Apocalypse", "Gain +25% probability of spawning a Lava Pool when your shot lands", "LavaPoolProb", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,0,0.25f,0)))),
            new Augment("LavaPoolSize","Heat Area", "Your Lava Pool grows by +2.5 units", "LavaPoolSize", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0.25f,0,0,0)))),
            new Augment("LavaPoolSize","Lava Lakes", "Your Lava Pool grows by +5 units", "LavaPoolSize", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0.5f,0,0,0)))),
            new Augment("LavaPoolSize","Inside the volcano", "Your Lava Pool grows by +10 units", "LavaPoolSize", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(1f,0,0,0)))),
            new Augment("LavaPoolDuration","Sear the ground", "Your Lava Pool lasts for +0.75 seconds", "LavaPoolDuration", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,0,0,0.75f)))),
            new Augment("LavaPoolDuration","Eternally Hot", "Your Lava Pool lasts for +1.5 seconds", "LavaPoolDuration", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,0,0,1.5f)))),
            new Augment("LavaPoolDuration","Unsettling Magma", "Your Lava Pool lasts for +3 seconds", "LavaPoolDuration", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new BurnOnLand(0,0,0,3f)))),
            ...
            new Augment("StatikDmg","Shock Dart", "Your Static Energy deals +10 extra damage", "StatikDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnHitEffect(new StatikOnHit(0,10,0)))),
            new Augment("StatikDmg","Shocking Advancement", "Your Static Energy deals +20 extra damage", "StatikDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnHitEffect(new StatikOnHit(0,20,0)))),
            new Augment("StatikDmg","Thor", "Your Static Energy deals +50 extra damage", "StatikDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnHitEffect(new StatikOnHit(0,50,0)))),
            ...
            new Augment("IcePoolSlow","Cold Bath", "Your Snow Pool will slow down enemies for 5% more", "IcePoolSlow", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0.05f,0,0)))),
            new Augment("IcePoolSlow","Glacial Grip", "Your Snow Pool will slow down enemies for 10% more", "IcePoolSlow", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0.1f,0,0)))),
            new Augment("IcePoolSlow","Frozen Stasis", "Your Snow Pool will slow down enemies for 20% more", "IcePoolSlow", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0.2f,0,0)))),
            new Augment("IcePoolProb","Cold Steps", "Gain +5% probability of spawning an Snow Pool when your shot lands", "IcePoolProb", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0.05f,0)))),
            new Augment("IcePoolProb","Ice here, Ice there", "Gain +10% probability of spawning an Snow Pool when your shot lands", "IcePoolProb", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0.1f,0)))),
            new Augment("IcePoolProb","The North Pole", "Gain +25% probability of spawning an Snow Pool when your shot lands", "IcePoolProb", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0.25f,0)))),
            new Augment("IcePoolSize","Cold breeze", "Your Snow Pool grows by +2.5 units", "IcePoolSize", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0.25f,0,0,0)))),
            new Augment("IcePoolSize","Frozen Lakes", "Your Snow Pool grows by +5 units", "IcePoolSize", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0.5f,0,0,0)))),
            new Augment("IcePoolSize","Inside the Iceberg", "Your Snow Pool grows by +10 units", "IcePoolSize", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(1f,0,0,0)))),
            new Augment("IcePoolDuration","Cooling Down", "Your Snow Pool lasts for +0.75 seconds", "IcePoolDuration", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0,0.75f)))),
            new Augment("IcePoolDuration","Eternally Cold", "Your Snow Pool lasts for +1.5 seconds", "IcePoolDuration", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0,1.5f)))),
            new Augment("IcePoolDuration","Absolute Frost", "Your Snow Pool lasts for +3 seconds", "IcePoolDuration", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnLandEffect(new IceOnLand(0,0,0,3f)))),
            ...
            new Augment("ExplodeProb","Bomb Rush", "Gain +5% chance to generate an explosion whenever you kill an enemy", "ExplodeProb", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Explosion(.05f,0)))), 
            new Augment("ExplodeProb","Grenade Launcher", "Gain +10% chance to generate an explosion whenever you kill an enemy", "ExplodeProb", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Explosion(.1f,0)))), 
            new Augment("ExplodeProb","Bombardment", "Gain +25% chance to generate an explosion whenever you kill an enemy", "ExplodeProb", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Explosion(.25f,0)))), 
            new Augment("ExplodeDmg","Cherry Bomb", "Generated explosions will deal +25 damage", "ExplodeDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Explosion(0,25)))),  
            new Augment("ExplodeDmg","Dynamite Blast", "Generated explosions will deal +50 damage", "ExplodeDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Explosion(0,50)))),  
            new Augment("ExplodeDmg","Nuke Blast", "Generated explosions will deal +100 damage", "ExplodeDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Explosion(0,100)))),  
            ...
            new Augment("NecroStats","Phantom Infusion", "Ghouls' damage will increase by 5% of your damage", "NecroStats", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Necromancer(0,.05f)))),  
            new Augment("NecroStats","Death's Embrace", "Ghouls' damage will increase by 15% of your damage", "NecroStats", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Necromancer(0,.15f)))),  
            new Augment("NecroStats","Hero's Spirit", "Ghouls' damage will increase by 35% of your damage", "NecroStats", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Necromancer(0,.35f)))),  
            ...
            new Augment("BulletsDmg","Round Shot", "Roundshots will deal +15 damage", "BulletsDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Bullets(0,15,0)))), 
            new Augment("BulletsDmg","Arggh!", "Roundshots will deal +30 damage", "BulletsDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Bullets(0,30,0)))),  
            new Augment("BulletsDmg","Fire of Thieves", "Roundshots will deal +75 damage", "BulletsDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addOnKillEffect(new Bullets(0,75,0)))),   
            ...
            new Augment("ThunderDmg","Volt Tackle", "Thunder will deal +25 damage on impact", "ThunderDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addTimeBasedEffect(new LightningEffect(0,25,0)))),  
            new Augment("ThunderDmg","Zap Cannon", "Thunder will deal +50 damage on impact", "ThunderDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addTimeBasedEffect(new LightningEffect(0,50,0)))), 
            new Augment("ThunderDmg","Lightning Synergy", "Thunder will deal +150 damage on impact", "ThunderDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addTimeBasedEffect(new LightningEffect(0,150,0)))), 
            ...
            new Augment("ImmolateDmg","Summer Heat", "Immolate will deal +20 damage", "ImmolateDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addTimeBasedEffect(new Immolate(0,25,0,0)))),
            new Augment("ImmolateDmg","Universal Damage", "Immolate will deal +40 damage", "ImmolateDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addTimeBasedEffect(new Immolate(0,40,0,0)))), 
            new Augment("ImmolateDmg","Nuclear Shockwave", "Immolate will deal +80 damage", "ImmolateDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addTimeBasedEffect(new Immolate(0,80,0,0)))),   
            ...
            new Augment("CandleDmg","Apprentice", "Candles will deal +10 damage", "CandleDmg", Tier.Silver, new UnityAction(() => Flamey.Instance.addNotEspecificEffect(new CandleTurrets(10, 0, 0)))), 
            new Augment("CandleDmg","Aether Infusion", "Candles will deal +20 damage", "CandleDmg", Tier.Gold, new UnityAction(() => Flamey.Instance.addNotEspecificEffect(new CandleTurrets(25, 0, 0)))), 
            new Augment("CandleDmg","Witchcraft Master", "Candles will deal +50 damage", "CandleDmg", Tier.Prismatic, new UnityAction(() => Flamey.Instance.addNotEspecificEffect(new CandleTurrets(50, 0, 0)))), 
