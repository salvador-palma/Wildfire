...
public class GameUI : MonoBehaviour
{
    ...
    public DynamicText BossNameTxt;
    public void SetBoss(Boss boss)
    {
        BossNameTxt.SetText(boss.Name);
        UpdateBossHP(boss.MaxHealth, boss.Health);
    ...
    public void UpdateBossHP(float MaxHealth, float Health)
    {
